...
class StripeWH_Handler:
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        while attempt <= 5:
            try:
                order = Order.objects.get(
                    ...
                    street_address1__iexact=shipping_details.address.line2,county__iexact=shipping_details.address.state,
        ...
        if order_exists:
            return HttpResponse(
                content=f'Webhook received: {event["type"]} | SUCCESS: Order already in database', status=200)
        else:
            order = None
            try:
                order = Order.objects.create(
                    ...
                    street_address2=shipping_details.address.line1,                street_address1=shipping_details.address.line2,
